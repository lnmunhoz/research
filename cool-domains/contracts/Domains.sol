...
contract Domains is ERC721URIStorage {
    ...
    // Constructor runs when deploying the contract.
    constructor(string memory _tld)
        payable
        ERC721("HUE Name Service", "HUENS")
    {
    ...
    function register(string calldata name) public payable {
        ...
        if (!isValidDomain(name)) revert InvalidName(name);
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "',
                        _name,
                        '", "description": "A domain on the HUE name service", "image": "data:image/svg+xml;base64,',
    ...
    function isValidDomain(string calldata name) public pure returns (bool) {
